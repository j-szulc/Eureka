            ...
            for attempt in range(1000):
                try:
                    if cfg.local_model_path:
                        ...
                        # docs https://huggingface.co/docs/transformers/en/main_classes/pipelines#natural-language-processing
                        pipe = pipeline(
                            "code-generation",
                            model=local_model,
                            tokenizer=tokenizer,
                        ...
                        response_cur = pipe(messages, num_return_sequences=chunk_size)
